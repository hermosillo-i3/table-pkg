   ...
   render() {
      ...
      switch (type) {
        ...
        case "date": {
          ...
          const disableHermosilloNonWorkingDays = typeof format === 'object' ? format.disable_hermosillo_non_working_days : false;
          ...
          return (
            <TableDatePicker
              ...
              filterDate={!disableHermosilloNonWorkingDays ? filterDate : isWorkingday}
